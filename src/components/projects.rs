...
const PROJECTS: [Project; 6] = [
    Project {
        ...
        tags: &["#C", "Unity", "VR"],
        github: "github.com/goracijCerv/AppTesinaVr",
    ...
    Project {
        ...
        tags: &["GIT", "GO"],
        github: "github.com/goracijCerv/cloak",
        demo: "",
        theme: "blue",
    },
    Project {
        ...
        tags: &["SQLite", "SQL", "GO"],
        github: "github.com/goracijCerv/students-api",
        demo: "",
        theme: "green",
    },
    Project {
        ...
        github: "github.com/yourusername/aurora-os",
        demo: "goracijcerv.github.io/portafolio/",
        theme: "purple",
    },
    Project {
        ...
        github: "github.com/goracijCerv/AuthECAPI",
        demo: "",
        theme: "blue",
    },
    Project {
        ...
        tags: &["Angular"],
        github: "github.com/goracijCerv/AuthCClient",
        demo: "",
        theme: "green",
    },
];
...
fn ProjectCard(#[prop(into)] project: Project, #[prop(into)] index: usize) -> impl IntoView {
    ...
    let (transform, set_transform) =
        signal("perspective(1000px) rotateX(0deg) translateY(0px)".to_string());
    ...
    let (dot_color, text_glow, tag_class) = match project.theme {
        "purple" => (
            "bg-aurora-purple shadow-[0_0_8px_var(--aurora-purple)]",
            "group-hover:text-aurora-purple-light",
            "bg-aurora-purple/10 border-aurora-purple/30 text-aurora-purple",
        ),
        "blue" => (
            "bg-aurora-blue shadow-[0_0_8px_var(--aurora-blue)]",
            "group-hover:text-aurora-blue-light",
            "bg-aurora-blue/10 border-aurora-blue/30 text-aurora-blue",
        ),
        "green" => (
            "bg-aurora-green shadow-[0_0_8px_var(--aurora-green)]",
            "group-hover:text-aurora-green-light",
            "bg-aurora-green/10 border-aurora-green/30 text-aurora-green",
        ),
        _ => (
            "bg-gray-mid",
            "group-hover:text-text-heading",
            "bg-gray-deep border-gray-mid text-text-main",
        ),
    };
    ...
    let on_mouse_move = move |e: web_sys::MouseEvent| {
        ...
        if let Some(card) = card_ref.get() {
            ...
            set_transform.set(format!(
                "perspective(1000px) rotateX({:.2}deg) rotateY({:.2}deg) translateY(-8px)",
                rx, ry
            ));
